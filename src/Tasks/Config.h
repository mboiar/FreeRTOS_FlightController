...
#define TASK_TELEM_STACK_SIZE 256U
#define TASK_SENSOR_STACK_SIZE 3000U
#define TASK_FLIGHTLOOP_STACK_SIZE 1524U
...
#define ESKF_SAN 0.5f   // m/s^2
#define ESKF_SWN 0.004f // rad/s
#define ESKF_SAW 5e-3f  // m/s^2/sqrtHz
#define ESKF_SWW 5e-4f  // rad/s/sqrtHz
#define EKSF_SMAG 0.02  // ?
#define EKSF_SBARO 0.02 // m ?
